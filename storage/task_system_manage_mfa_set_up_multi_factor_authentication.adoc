...
+
Os metadados do IdP, em formato de texto simples, são obtidos do IdP de terceiro. Esses metadados precisam ser validados para garantir que estejam formatados corretamente em JSON. Existem diversos aplicativos de formatação JSON disponíveis que você pode usar, por exemplo: https://freeformatter.com/json-escape.html.
