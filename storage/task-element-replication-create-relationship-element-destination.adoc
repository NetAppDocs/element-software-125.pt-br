...
summary: A partir do ONTAP 9.4, você pode usar o SnapMirror para replicar cópias snapshot de um LUN criado em uma fonte ONTAP de volta para um destino do Element. 
---
