...
Para obter mais informações, link:../storage/element-replication-index.html["Executar replicação entre o software NetApp Element e o ONTAP (CLI do ONTAP)"]consulte .
